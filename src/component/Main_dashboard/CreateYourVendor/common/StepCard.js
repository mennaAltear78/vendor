...
export const StepCard = ({
  ...
  return (
    <div className="font-usedFont pl-2 p-1 pr-3 ml-0 ms:ml-5 w-[200px] sm:w-[850px] border-solid border-2 border-gray-400/20 rounded-[25px] text-[15px] flex flex-wrap justify-between items-center mb-4">
