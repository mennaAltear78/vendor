...
function ChooseHotel() {
  ...
  useEffect(() => {
    document.title = "Choose Your Property Type";
  }, []);

  return (
    <MainDashBoardWrapper>
      <form onSubmit={onClickHandler} className="w-[90%]   sm:ml-[150px]  ">
        <div className="sm:w-[88vw] w-[100vw]">
          <CreateHotelWrapper clickHandeler={clickPrivHandeler}>
            <div>
              ...
              <div className="flex flex-wrap  gap-[10px] mb-[200px] justify-center sm:justify-start sm:ml-[20px] ">
