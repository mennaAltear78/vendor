...
const NumberOfImgToAdd=0
  return (
    <div className="px-[30px] sm:px-4 mr-[15px] sm:mr-0 mt-4  mb-[100px] sm:w-[700px]  w-[330px] bg-white rounded-lg  p-2 shadow-lg">
        <ImageContainer idHotel={data?._id} ImagesData={''} NumberOfImgToAdd={NumberOfImgToAdd}  Name="Room Images" Note={`(you can add at most ${NumberOfImgToAdd } images)`} spaceBetween={100}/>
         <RoomDetails/>
