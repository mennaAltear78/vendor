...
const RoomView = ({ id }) => {
  ...
  if (error) {
    return (
      <div>
        <h2 className="sm:ml-0 ml-3">Rooms </h2>
        <div className="flex flex-col items-center justify-center">
          <button
            onClick={() => navigate("/CreateRoom")}
            className="bg-[#2F32DE] mt-5 mb-5 w-[210px] place-content-center pt-[7px] cursor-pointer flex h-[37px] text-sm items-center pb-[7px]  text-white font-bold rounded-[10px] gap-3 outline-none border-none"
          >
